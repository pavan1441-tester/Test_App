...
public class UCAppData extends CommonExcel
{
	...
	public static Object[][] getData(Sheet sheet, int iCount) throws Exception
	{
		...
		for(int i = 0; i < iCount; i++)
		{
			...
			plan.sUsername  					= CommonExcel.getExcelCellValue(iRow, 0);
			plan.sPassword				    = CommonExcel.getExcelCellValue(iRow, 1);
	...
	{
		return "ComboAppData [iTestCaseID=" + iTestCaseID + ", sUsername="
