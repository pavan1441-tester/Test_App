...
public class MySitesActivateDeactivePage extends ComboAppBasePage 
 {
	
	public MySitesActivateDeactivePage() 
	{
		super();
	}			
		...
		public void fnMySitesActivateDeactive(int iTestCaseID, UCAppData testData) throws Exception 
		{
			...
			clickOnSitesModule.click();
   		   ...
   		   // sendValue(enterSiteName,"Test My Site 514");
   		    ...
   		    List <WebElement> listings1 = CommonClass.driver.findElements(By.xpath("//*[@id='select2-filters_items_location_site_name_v-results']/li"));
     	    Random r1 = new Random();
	        int randomValue1 = r1.nextInt(listings1.size()); //Getting a random value
