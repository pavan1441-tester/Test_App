	...
	public class ReportSummaryExportPage extends ComboAppBasePage {

		public ReportSummaryExportPage() 
		{
			super();
		}			
					...
					//On New Pop-up Page-SP Report
					
					//Click on SP Report Button
					@FindBy(css="#report_report_type_sp")
					private WebElement spReportButton;
					
					
					@FindBy(xpath="//*[@id='report_service_start_time']")
					private WebElement spReportButtoncle;
					
					
					//report dates 
					String Startdate="06/27/2021 12:00 AM";
					...
					public void fnExportManagerReport(int iTestCaseID, UCAppData testData) throws Exception 
					{
						...
						spReportButtoncle.clear();
						
						spReportButtoncle.sendKeys(Startdate);
					...
					public void fnExportSPReport(int iTestCaseID, UCAppData testData) throws Exception
					{
						waitForThread(CommonClass.iWaitForThread);
						WebElementNvbar.click();
						waitForThread(CommonClass.iWaitForThread2);
