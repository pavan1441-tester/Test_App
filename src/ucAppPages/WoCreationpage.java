...
public class WoCreationpage extends ComboAppBasePage {

	public WoCreationpage() 
	{
		super();
	}
   ...
   //Site aelection click opration
	...
	//date selection
		...
		//Client Billing method selection
				...
				@FindBy(xpath="//*[@id='select2-work_order_trips_attributes_0_tradesmen_ids-results']/li[1]/ul/li[1]")
		...
		public void fnworkordcreation(int iTestCaseID, UCAppData testData) throws Exception 
		{
		...
		//	weworkorderDeptsel.click();
	      ...
	      //*[@id="select2-work_order_wo_trade_ids-results"]/li
			...
			weworkorderclosedate.sendKeys("10/21/2021 - 12:15 PM");
			System.out.println("close date select properly");
			waitForThread(CommonClass.iWaitForThread2);
			wewtripstartdate.clear();
			waitForThread(CommonClass.iWaitForThread1);
			//wewtripstartdate.click();
			wewtripstartdate.sendKeys("10/14/2021 - 12:18 PM");
			waitForThread(CommonClass.iWaitForThread2);
